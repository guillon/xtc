...
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['b', 'h', 'w', 'f'], loop_stamps=[], splits={}, tiles={'b': {'b': 1}, 'h': {'h': 1}, 'w': {'w': 1}, 'f': {'f': 1}}, permutation={'.': ['b', 'h', 'w', 'f']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['b', 'h', 'w', 'f', 'r', 's', 'c'], loop_stamps=[], splits={}, tiles={'b': {'b': 1, 'b1': 1}, 'h': {'h': 1, 'h1': 1}, 'w': {'w': 1, 'w1': 1}, 'f': {'f': 1, 'f1': 1}, 'r': {'r': 1}, 's': {'s': 1}, 'c': {'c': 1}}, permutation={'%2': ['b', 'h', 'w', 'f', 'r', 's', 'c', 'b1', 'h1', 'w1', 'f1']}, vectorization=['f1'], parallelization=[], unrolling={'f1': 1, 'w1': 1, 'h1': 1, 'b1': 1})]
# CHECK-NEXT:  schedule O1: [1, 1, 1, 1]
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['b', 'h', 'w', 'f'], loop_stamps=[], splits={}, tiles={'b': {'b': 1}, 'h': {'h': 1}, 'w': {'w': 1}, 'f': {'f': 1}}, permutation={'.': ['b', 'h', 'w', 'f']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['b', 'h', 'w', 'f', 'r', 's', 'c'], loop_stamps=[], splits={}, tiles={'b': {'b': 1, 'b1': 1}, 'h': {'h': 1, 'h1': 1}, 'w': {'w': 1, 'w1': 1}, 'f': {'f': 1, 'f1': 1}, 'r': {'r': 1}, 's': {'s': 1}, 'c': {'c': 1}}, permutation={'%2': ['b', 'h', 'w', 'f', 'r', 's', 'c', 'b1', 'h1', 'w1', 'f1']}, vectorization=['f1'], parallelization=[], unrolling={'f1': 1, 'w1': 1, 'h1': 1, 'b1': 1})]
# CHECK-NEXT:  schedule O2: [1, 1, 2, 16]
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['b', 'h', 'w', 'f'], loop_stamps=[], splits={}, tiles={'b': {'b': 1}, 'h': {'h': 1}, 'w': {'w': 1}, 'f': {'f': 1}}, permutation={'.': ['b', 'h', 'w', 'f']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['b', 'h', 'w', 'f', 'r', 's', 'c'], loop_stamps=[], splits={}, tiles={'b': {'b': 1, 'b1': 1}, 'h': {'h': 1, 'h1': 1}, 'w': {'w': 2, 'w1': 1}, 'f': {'f': 16, 'f1': 1}, 'r': {'r': 1}, 's': {'s': 1}, 'c': {'c': 1}}, permutation={'%2': ['b', 'h', 'w', 'f', 'r', 's', 'c', 'b1', 'h1', 'w1', 'f1']}, vectorization=['f1'], parallelization=[], unrolling={'f1': 16, 'w1': 2, 'h1': 1, 'b1': 1})]
...
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['b', 'h', 'w', 'f'], loop_stamps=[], splits={}, tiles={'b': {'b': 1}, 'h': {'h': 1}, 'w': {'w': 1}, 'f': {'f': 1}}, permutation={'.': ['b', 'h', 'w', 'f']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['b', 'h', 'w', 'f', 'r', 's', 'c'], loop_stamps=[], splits={}, tiles={'b': {'b': 2, 'b1': 1}, 'h': {'h': 2, 'h1': 1}, 'w': {'w': 2, 'w1': 1}, 'f': {'f': 16, 'f1': 1}, 'r': {'r': 1}, 's': {'s': 1}, 'c': {'c': 1}}, permutation={'%2': ['b', 'h', 'w', 'f', 'r', 's', 'c', 'b1', 'h1', 'w1', 'f1']}, vectorization=['f1'], parallelization=[], unrolling={'f1': 16, 'w1': 2, 'h1': 2, 'b1': 2})]
