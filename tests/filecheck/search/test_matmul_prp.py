...
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 1, 'i1': 1}, 'j': {'j': 1, 'j1': 1}, 'k': {'k': 1}}, permutation={'%2': ['i', 'j', 'k', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 1, 'i1': 1})]
# CHECK-NEXT:  schedule O1: [1, 1]
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 1, 'i1': 1}, 'j': {'j': 1, 'j1': 1}, 'k': {'k': 1}}, permutation={'%2': ['i', 'j', 'k', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 1, 'i1': 1})]
# CHECK-NEXT:  schedule O2: [1, 16]
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 1, 'i1': 1}, 'j': {'j': 16, 'j1': 1}, 'k': {'k': 1}}, permutation={'%2': ['i', 'j', 'k', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 16, 'i1': 1})]
# CHECK-NEXT:  schedule O3: [3, 16]
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 3, 'i1': 1}, 'j': {'j': 16, 'j1': 1}, 'k': {'k': 1}}, permutation={'%2': ['i', 'j', 'k', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 16, 'i1': 3})]
...
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_0', node_ident='__xtc_id_%2_0_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2', node_ident='__xtc_id_%2_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 7, 'i1': 1}, 'j': {'j': 16, 'j1': 1}, 'k': {'k': 1}}, permutation={'%2': ['i', 'j', 'k', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 16, 'i1': 7})]
