...
# CHECK-NEXT:  b, b1, b2, b3, = sch.split(b, factors=[None, 1, 1, 1])
# CHECK-NEXT:  h, h1, h2, h3, = sch.split(h, factors=[None, 1, 1, 1])
# CHECK-NEXT:  w, w1, w2, w3, = sch.split(w, factors=[None, 2, 1, 2])
# CHECK-NEXT:  f, f1, f2, f3, = sch.split(f, factors=[None, 16, 1, 16])
# CHECK-NEXT:  r, r1, = sch.split(r, factors=[None, 1])
# CHECK-NEXT:  s, s1, = sch.split(s, factors=[None, 1])
# CHECK-NEXT:  c, c1, = sch.split(c, factors=[None, 1])
# CHECK-NEXT:  sch.reorder(b, h, w, f, b1, h1, w1, f1, r, s, c, b2, h2, w2, f2, r1, s1, c1, b3, h3, w3, f3)
...
# CHECK-NEXT:  O_W0 = sch.cache_write(O, 0, "global")
# CHECK-NEXT:  b, b1, b2, b3, = sch.split(b, factors=[None, 1, 1, 1])
# CHECK-NEXT:  h, h1, h2, h3, = sch.split(h, factors=[None, 2, 1, 2])
# CHECK-NEXT:  w, w1, w2, w3, = sch.split(w, factors=[None, 2, 1, 1])
# CHECK-NEXT:  f, f1, f2, f3, = sch.split(f, factors=[None, 32, 1, 32])
# CHECK-NEXT:  r, r1, = sch.split(r, factors=[None, 1])
# CHECK-NEXT:  s, s1, = sch.split(s, factors=[None, 1])
# CHECK-NEXT:  c, c1, = sch.split(c, factors=[None, 3])
# CHECK-NEXT:  sch.reorder(b, h, w, f, b1, h1, w1, f1, r, s, c, b2, h2, w2, f2, r1, s1, c1, b3, h3, w3, f3)
